    ...
    <div id="kt_content_container" class="container-xxl">
                    ...
                    <div class="me-7 mb-4">
                        <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                            ...
                            <div class="image-input-wrapper">
                                <img src="{{asset('uploads/profile/')}}/{{auth()->user()->profile_photo}}" alt="" class="img-fluid" width="100">
                            </div>
                            @else
                            <div class="image-input-wrapper">
                                <img src="{{asset('uploads/profile/index.png')}}" alt="">
                            </div>
                            @endif
                        ...
                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                    ...
                                    <!--end::Svg Icon-->{{Str::title(auth()->user()->role)}}</a>
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form action="{{route('admin.profile.setting.post')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!--begin::Card body-->
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url('assets/media/svg/avatars/blank.svg')">
                                    ...
                                    @if (auth()->user()->profile_photo)
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image:url('{{asset('uploads/profile/')}}/{{auth()->user()->profile_photo}}') "></div>
                                    @else
                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{asset('uploads/profile/index.png')}})"></div>
                                    @endif
